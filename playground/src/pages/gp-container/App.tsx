...
function NavTargetContent() {
  ...
  return (
    <DemoPage title="导航目标页">
      {/* Container */}
      <view className={dk('gpc-section')}>
        <text className={dk('gpc-section-title')}>容器信息</text>
      ...
      {schemeKeys.length > 0 ? (
        <view className={dk('gpc-section')}>
          <text className={dk('gpc-section-title')}>Scheme 参数</text>
      ...
      {/* Custom Params */}
      <view className={dk('gpc-section')}>
        <text className={dk('gpc-section-title')}>自定义参数</text>
        {customKeys.length > 0 ? (
          <view className={dk('gpc-qi-list')}>
      ...
      <view className={dk('gpc-section')}>
        ...
        >
          <text className="gpc-close-text">关闭页面</text>
        </view>
      </view>
    </DemoPage>
  )
