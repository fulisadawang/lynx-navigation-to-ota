...
核对分支：Lynx `4.1.0`；Sparkling `main`。
...
| 版本映射 | `explorer/harmony/parameter.json`、根 `oh-package.json5`、本工程 `parameter.json` |
...
| Native Module | `module/ExplorerModule.ets` 与 Lynx 4.1 Native Modules 文档 |
...
Sparkling Runtime 本身没有进入 Lynx 4.1 默认依赖链。
